...
export function UserProfile({ onOpenSidebar }: UserProfileProps) {
  ...
  return (
    <div className="flex flex-col">
      <div
        className="flex-1 overflow-auto bg-[#0e0e10] dark:bg-gray-50"
        style={{ backgroundColor: isLightAppearance ? '#f8fafc' : '#0e0e10' }}
      >
        <div
          ...
          style={{
            ...
            borderBottom: isLightAppearance ? '1px solid #e5e7eb' : '1px solid #2d2d31',
            minHeight: '190px',
          }}
        >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          <div className="relative -mt-16 sm:-mt-20 mb-8">
            <div
              ...
              style={{
                backgroundColor: isLightAppearance ? '#ffffff' : 'transparent',
                border: isLightAppearance ? '1px solid #e5e7eb' : '1px solid transparent',
                borderRadius: isLightAppearance ? '24px' : 0,
                boxShadow: isLightAppearance ? '0 18px 48px rgba(15, 23, 42, 0.08)' : 'none',
                padding: isLightAppearance ? '1rem 1rem 1.25rem' : 0,
              }}
            >
              <div className="relative">
                <div
                  ...
                  style={{
                    border: isLightAppearance ? '4px solid #ffffff' : '4px solid #0e0e10',
              ...
              <div className="flex-1 pb-4 text-center sm:text-left">
                <div className="flex flex-col sm:flex-row items-center gap-4 mb-3">
                  <h1
                    className="text-3xl sm:text-4xl text-white dark:text-gray-900"
                    style={{ color: isLightAppearance ? '#111827' : '#ffffff' }}
                  >
                ...
                <div className="mb-2">
                  <div className="flex items-center justify-between text-sm mb-2">
                    <span
                      ...
                      style={{ color: isLightAppearance ? '#475569' : '#ffffff' }}
                    >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isLightAppearance ? '#e5e7eb' : '#1a1a1d',
                      border: isLightAppearance ? '1px solid #d1d5db' : '1px solid #2d2d31',
                      height: '12px',
                    }}
                  >
                    <div
                ...
                <p
                  ...
                  style={{ color: isLightAppearance ? '#334155' : '#d1d5db' }}
                >
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div
              ...
              style={{
                backgroundColor: isLightAppearance ? '#ffffff' : '#18181b',
                border: isLightAppearance ? '1px solid #e5e7eb' : '1px solid #2d2d31',
                boxShadow: isLightAppearance ? '0 12px 32px rgba(15, 23, 42, 0.06)' : 'none',
              }}
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div
                  ...
                  style={{ color: isLightAppearance ? '#334155' : '#9ca3af' }}
                >
                  {t('profile.achievementsUnlocked')}
                </div>
              </div>
              <div
                className="text-2xl sm:text-3xl text-white dark:text-gray-900"
                style={{ color: isLightAppearance ? '#111827' : '#ffffff' }}
              >
          ...
          >
            <h2
              className="text-xl sm:text-2xl text-white dark:text-gray-900 mb-4 sm:mb-6"
              style={{ color: isLightAppearance ? '#111827' : '#ffffff' }}
            >
            ...
            {!isLeaderboardLoading && !leaderboardError && leaderboardEntries.length === 0 && (
              <div
                ...
                style={{
                  backgroundColor: isLightAppearance ? '#f8fafc' : 'transparent',
                  border: isLightAppearance ? '1px dashed #cbd5e1' : '1px dashed #2d2d31',
                  color: isLightAppearance ? '#475569' : '#9ca3af',
                }}
              >
