...
const EN_TRANSLATIONS: TranslationMap = {
  ...
  'marketplace.category.message': 'Chat Messages',
  'marketplace.category.message_content': 'Message Keyword',
  'marketplace.category.channel_point_cost': 'Channel Points',
  'marketplace.category.redeem_channel_point': 'Point Redemption',
  'marketplace.category.api_caller': 'External Trigger',
  ...
  'viewerHub.badges.title': 'My Badges',
  ...
  'badge.channel.ownerOnly': 'Only the channel owner can manage the channel badge.',
  'badge.channel.noChannel': 'Select a channel to manage its badge.',
  'profile.leaderboard.loading': 'Loading leaderboard...',
  'profile.leaderboard.empty': 'No leaderboard data yet.',
  'profile.leaderboard.you': 'You',
  ...
  'viewerHub.all': 'All',
  'viewerHub.channelTotal': '{n} achievements total',
  'viewerHub.channelCompleted': 'completed',
  'viewerHub.emptyFilter': 'No achievements in this category.',
  'viewerHub.back': 'Back',
  ...
  'settings.subtitle': 'Manage your profile, display preferences, and data privacy.',
  'settings.account.title': 'Account',
  'settings.account.sectionDescription': 'Review the Twitch account connected to Stream Quest.',
  'settings.account.description': 'Twitch connection active for this workspace.',
  'settings.account.username': 'Username',
  'settings.account.channel': 'Channel',
  'settings.account.connectedVia': 'Connected via Twitch',
  'settings.account.fallbackName': 'Not signed in',
  'settings.preferences.title': 'Preferences',
  'settings.preferences.description': 'Adjust the interface without leaving your dashboard.',
  'settings.preferences.appearance': 'Appearance',
  'settings.preferences.appearanceDescription': 'Change the color theme used by the application.',
  'settings.preferences.themeAction.light': 'Switch to light mode',
  'settings.preferences.themeAction.dark': 'Switch to dark mode',
  'settings.preferences.language': 'Language',
  'settings.preferences.languageDescription': 'Choose the language used across the interface.',
  'settings.dangerZone.title': 'Data and privacy',
...
const FR_TRANSLATION_OVERRIDES: Partial<TranslationMap> = {
  ...
  'marketplace.category.message': 'Messages chat',
  'marketplace.category.message_content': 'Mot-cl\u00e9 de message',
  'marketplace.category.channel_point_cost': 'Points de cha\u00eene',
  'marketplace.category.redeem_channel_point': 'R\u00e9compense de points',
  'marketplace.category.api_caller': 'D\u00e9clencheur externe',
  ...
  'viewerHub.badges.title': 'Mes badges',
  ...
  'badge.channel.ownerOnly': 'Seul le propriétaire de la chaîne peut gérer le badge de la chaîne.',
  'badge.channel.noChannel': 'Sélectionne une chaîne pour gérer son badge.',
  'profile.leaderboard.loading': 'Chargement du classement...',
  'profile.leaderboard.empty': 'Pas encore de données de classement.',
  'profile.leaderboard.you': 'Vous',
  'management.apicaller.endpoint.label': 'Endpoint',
  ...
  'viewerHub.channelCompleted': 'complété',
  'viewerHub.emptyFilter': 'Aucun succès dans cette catégorie.',
  'viewerHub.back': 'Retour',
  ...
  'settings.subtitle': 'Gérez votre profil, vos préférences d’affichage et vos données.',
  'settings.account.title': 'Compte',
  'settings.account.sectionDescription': 'Vérifiez le compte Twitch connecté à Stream Quest.',
  'settings.account.description': 'Connexion Twitch active pour cet espace.',
  'settings.account.username': 'Nom d’utilisateur',
  'settings.account.channel': 'Chaîne',
  'settings.account.connectedVia': 'Connecté via Twitch',
  'settings.account.fallbackName': 'Non connecté',
  'settings.preferences.title': 'Préférences',
  'settings.preferences.description': 'Ajustez l’interface sans quitter votre tableau de bord.',
  'settings.preferences.appearance': 'Apparence',
  'settings.preferences.appearanceDescription': 'Changez le thème de couleur utilisé dans l’application.',
  'settings.preferences.themeAction.light': 'Passer en mode clair',
  'settings.preferences.themeAction.dark': 'Passer en mode sombre',
  'settings.preferences.language': 'Langue',
  'settings.preferences.languageDescription': 'Choisissez la langue utilisée dans l’interface.',
  'settings.dangerZone.title': 'Données et confidentialité',
  'settings.dangerZone.description':
