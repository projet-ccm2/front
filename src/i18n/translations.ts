...
const EN_TRANSLATIONS: TranslationMap = {
  ...
  'settings.account.description': 'Your Twitch connection used across Stream Quest.',
  ...
  'settings.preferences.description': 'Customize how Stream Quest looks and feels.',
  'settings.preferences.appearance': 'Appearance',
  'settings.preferences.appearanceDescription': 'Switch between light and dark theme.',
  'settings.preferences.language': 'Language',
  'settings.preferences.languageDescription': 'Choose the language used across the app.',
...
const FR_TRANSLATION_OVERRIDES: Partial<TranslationMap> = {
  ...
  'settings.account.description': 'Votre connexion Twitch utilisée dans Stream Quest.',
  ...
  'settings.preferences.description': 'Personnalisez l’apparence de Stream Quest.',
  'settings.preferences.appearance': 'Apparence',
  'settings.preferences.appearanceDescription': 'Basculez entre le thème clair et sombre.',
  'settings.preferences.language': 'Langue',
  'settings.preferences.languageDescription': 'Choisissez la langue utilisée dans l’application.',
