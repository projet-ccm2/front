...
const FR_TRANSLATION_OVERRIDES: Partial<TranslationMap> = {
  ...
  'management.search': 'Rechercher des achievements...',
  'management.loading': 'Chargement des achievements...',
  'management.channel': 'Chaîne',
  'management.empty.title': 'Aucun achievement pour cette chaîne',
  'management.empty.subtitle': 'Créez votre premier achievement ou ajustez les filtres.',
