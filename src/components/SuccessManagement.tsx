          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-2xl sm:text-3xl text-white dark:text-gray-900 mb-2">Manage Achievements</h1>
                  ...
                  <div className="flex-1 min-w-0 w-full">
                    <div className="flex flex-col sm:flex-row items-start justify-between mb-3 gap-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg sm:text-xl text-white dark:text-gray-900 mb-1">{achievement.title}</h3>
                        <p className="text-gray-400 dark:text-gray-600 text-sm sm:text-base">{achievement.description}</p>
                      </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white dark:text-gray-900">{achievement.completion}%</span>
                      </div>
                    </div>
